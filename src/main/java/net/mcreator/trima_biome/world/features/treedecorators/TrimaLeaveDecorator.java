...
public class TrimaLeaveDecorator extends LeaveVineDecorator {
	public static final TrimaLeaveDecorator INSTANCE = new TrimaLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("trima_tree_leave_decorator", tdt);
	}

	public TrimaLeaveDecorator() {
		super(0.25f);
	}
